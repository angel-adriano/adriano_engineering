...
class OrderFeed(models.Model):
    ...
    shipping_state_name = fields.Char(
        string='Shipping State Name'
    )
    shipping_state_id = fields.Char(
        string='Shipping State Code'
    )
